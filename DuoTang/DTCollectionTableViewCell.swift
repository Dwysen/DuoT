//
//  DTCollectionTableViewCell.swift
// DuoTang
//
...
class DTCollectionTableViewCell: UITableViewCell {
    ...
    var post:DTCollecitonPost? {
        didSet {
        bgImageView.kf_setImageWithURL(NSURL(string: post!.coverImageUrl)!)
        titleLabel.text = post?.title
        likeBtn.setTitle("\(post!.likesCount!)", forState: .Normal)
